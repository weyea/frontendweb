	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement('div', { 'class': 'alerts' }),
	            React.createElement(
	              'div',
	              { 'class': 'form-group ' },
	              React.createElement(
	              ...
	              React.createElement('input', { type: 'text', name: 'username', value: '', 'class': 'form-control' }),
	            ...
	            React.createElement(
	              ...
	              React.createElement('input', { type: 'text', name: 'email', value: '', 'class': 'form-control' }),
	              React.createElement('span', { 'class': 'help-block' })
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement('input', { type: 'password', name: 'password', value: '', 'class': 'form-control' }),
	              React.createElement('span', { 'class': 'help-block' })
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                'button',
	                { type: 'submit', 'class': 'btn btn-primary btn-signup' },
	                'Create My Account'
	              )
	            )
	          )
